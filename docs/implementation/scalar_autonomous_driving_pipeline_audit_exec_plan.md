...
| `docker compose ... pytest -q tests/test_rulebook_v2_*.py` | PASS | 2026-07-19 | 143 Rulebook v4.7 tests pass, 1 environment-dependent test skipped; live adapter wiring remains a separate blocker. |
