...
`../specifications/automatic_curriculum_learning_v1_specification.md` as a new curriculum kind,
...
- replay currently works, but it carries explicit compatibility debt with the
  ...
  `../specifications/automatic_curriculum_learning_v1_specification.md`
