...
| ScenarioNet catalog build parallelization | `specifications/scenarionet_integration_spec_v1.md` v1 | `implementation/scenarionet_catalog_build_parallelization_exec_plan.md` | `IMPLEMENTED` | 2026-07-16 |
