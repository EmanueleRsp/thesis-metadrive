...
| Semantic observation v1.1 | `specifications/observation_v1.1_specification.md`; ID `OBS-V1.1`, version `1.1-final-implementation-complete`, amended 2026-07-17 by ADR-004 | `AUTHORITATIVE`; explicit user approvals 2026-07-16 and 2026-07-17 | `implementation/semantic_observation_encoder_v1_exec_plan.md`; `IN_PROGRESS`; v1.1 schema, strict `(2541,)` adapter, causal-context boundary, assigned-route persistence, metadata-only adapters, and causal LiDAR wiring exist; the environment-owned semantic batch builder remains to be implemented | Complete causal batch builder/installation, full sensor smoke validation, and reconcile before `VERIFIED` |
