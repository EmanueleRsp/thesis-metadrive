...
def build_waymo_static_adapter_result(scenario: Mapping[str, Any], *, scenario_uid: str, adapter_version: str = "waymo-v2") -> StaticAdapterResult:
    ...
    return normalize_static_records(scenario_uid=scenario_uid, task_route=route, route_lanes=tuple(lanes.values()), map_features=tuple(map_records), traffic_controls=tuple(controls))
